...
import { NewsArticle } from "@/lib/utils/definitions";
import { getFinanceNews } from "@/lib/utils/news-utils";
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2">
      {articles.map((article, i) => (
        <Card
          key={i}
          className="overflow-hidden hover:bg-zinc-900/50 transition-colors"
        >
