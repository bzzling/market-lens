...
export default function AIChat() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response =
        "I'm a placeholder response. The AI chat feature is coming soon!";
      setMessages((prev) => [
        ...prev,
      ...
      <div className="space-y-4">
        ...
        <form onSubmit={handleSubmit} className="flex gap-2 items-center">
          ...
          <button
            ...
            className="px-4 py-2 bg-primary text-primary-foreground rounded-md disabled:opacity-50 h-fit"
          >
            Send
          </button>
        </form>
